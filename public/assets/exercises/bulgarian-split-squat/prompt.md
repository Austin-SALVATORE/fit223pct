# Bulgarian Split Squat — image generation prompt
...
- Hips stay square and level — no rotation toward the rear leg.
- Torso stays tall with a neutral spine; the descent is straight down, not
  forward.
```

# Single-Leg Hip Thrust — image generation prompt
...
> Bodyweight unilateral variation of the hip-thrust asset: same bench setup,
> no barbell. One foot is planted while the other leg stays extended straight
> for the whole rep — the raised straight leg makes it unmistakably one-sided.
...
Camera: bench-side view, so the bench height, the hip travel arc, the planted
shin and the extended free leg are all clearly readable.
...
1. Setup. Seated on the ground with her upper back against the edge of the
   bench pad, the bench edge sitting just under the shoulder blades. The near
   (left) foot is flat on the ground with the heel placed so the shin will be
...
- The right leg stays completely straight and off the ground for the entire
  rep — it never bends and the foot never touches down.
- The pelvis stays level; the free-leg side of the hips never sags or drops.
- The bench edge stays just below the shoulder blades and the bench must not
  move.
- At lockout the planted shin is vertical, the foot flat, the heel down.
...
- The chin stays tucked with the gaze forward, not thrown back.
```

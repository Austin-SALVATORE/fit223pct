# Bodyweight Squat — image generation prompt
...
2. Early descent, roughly a quarter squat. Hips have travelled back, knees bent
   about 30 degrees, torso leaning forward only a few degrees, arms beginning
   to lift forward.

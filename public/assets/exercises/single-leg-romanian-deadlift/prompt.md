# Single-Leg Romanian Deadlift — image generation prompt
...
Camera: side view, so the hip hinge, the flat back and the straight line from
head to rear heel are all clearly readable.
...
- The dumbbell hangs vertically and stays close to the stance leg.
- The lumbar spine stays neutral at every point — no rounding.
```

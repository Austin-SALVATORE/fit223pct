# Hack Squat — image generation prompt
...
Exercise: Hack Squat
Camera: machine three-quarter view so the angled sled, the shoulder pads, the
guide rails and the squat depth are all clearly readable.
Equipment: one matte black angled sled with a large flat footplate, black
shoulder pads, and chrome guide rails. The figure stands on the footplate with
her back and hips flat against the sled's back pad, shoulders under the
...
- Hips and lower back stay in full contact with the back pad — no gap opens
  at the bottom.
- Heels stay flat on the footplate through the whole rep.
- Knees track in line with the toes, never collapsing inward.
- The carriage travels only along the line of the guide rails.
- Knees never snap into a hard lockout at the top.
```

...
2. Half squat, thighs at roughly 45 degrees. Knees tracking forward over the
   toes, heels flat, torso more upright than in a free-weight squat.
3. Bottom position, deepest point. Thighs parallel to the ground, heels flat,
   knees in line with the toes, spine neutral, bar still exactly on the
   vertical rail line.
4. Ascent, back to roughly a half squat. Hips and chest rising together at
...
- [ ] Bar stays on one vertical line in all four frames — no drift off the rails
...
- [ ] Machine frame identical scale and position in all four frames

# Seated Dumbbell Shoulder Press — image generation prompt
...
1. Start position, seated. Hips all the way back into the seat, the upper
   back and shoulder blades in contact with the back pad, feet flat on the
   ground roughly hip-width apart. Dumbbells at shoulder height just outside
...
- The upper back and shoulder blades stay in contact with the back pad in
  every frame — the torso never peels off the bench.
- The lower back keeps its natural curve; it does not arch away from the pad
  as the weights lock out.
- Both feet stay flat on the ground the whole time, knees at roughly 90 degrees.
- Wrists stay stacked over the elbows — no bending back under the load.
